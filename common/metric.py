...
if __name__ == "__main__":
    ...
    # Test Accuracy
    predicts = [torch.from_numpy(np.array([[0.3, 0.7], 
                                           [0, 1.], 
                                           [0.4, 0.6]]))]
    # print("predicts.shape ", predicts.shape)
    # print("predicts.shape ", predicts[0].shape)
    ...
    logging.debug("input loss: {}".format(losses))
    ...
    # print("calling metrics.get() = ",metrics.get())
    # print("calling metrics.get_name_value : ",metrics.get_name_value())
    # print("calling acc.get_name_value : ",acc.get_name_value())
